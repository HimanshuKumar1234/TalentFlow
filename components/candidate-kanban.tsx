            ...
            <Card key={stage.id} className="glass-effect border-border/50">
              ...
              <CardContent className="p-0">
                <Droppable droppableId={stage.id}>
                  {(provided, snapshot) => (
                    <ScrollArea className="h-[calc(100vh-500px)]" ref={provided.innerRef} {...provided.droppableProps}>
                      <div className={cn("p-3 space-y-3 min-h-[200px]", snapshot.isDraggingOver && "bg-accent/20")}>
